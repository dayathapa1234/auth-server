 ...
 */
@Generated
public class AuthServerApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new AuthServerApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new AuthServerApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
